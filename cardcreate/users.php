...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <?php require_once("./includes/users_page_heading.php"); ?>

                    <!-- Content Row -->
                    <?php require_once("./includes/users_table.php"); ?>
    ...
    <script>
        function suspendUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Envoyer une requête AJAX pour suspendre l'utilisateur
                    fetch('users_actions/ban.php', {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            // Vous pouvez ajouter un code ici pour rafraîchir la page ou mettre à jour la liste des utilisateurs.
                            location.reload();
                        } else {
                            Swal.fire(
                                'Erreur!',
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('users_actions/delete.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
        ...
        function restoreUser(userId) {
            Swal.fire({
                title: 'Êtes-vous sûr?',
                text: "Voulez-vous vraiment restaurer cet utilisateur?",
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    // Envoyer une requête AJAX pour restaurer l'utilisateur
                    fetch('users_actions/restore.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
    ...
    <!-- Required DataTables buttons JS -->
